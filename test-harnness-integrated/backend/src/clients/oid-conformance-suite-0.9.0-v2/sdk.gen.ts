 ...
 * Upload an image
 */
export const uploadImage = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<UploadImageData, ThrowOnError>) => {
 ...
 */
export const createCertification = <ThrowOnError extends boolean = false>(options?: OptionsLegacyParser<CreateCertificationData, ThrowOnError>) => {
    return (options?.client ?? client).post<CreateCertificationResponse, CreateCertificationError, ThrowOnError>({
        ...options,
        url: '/certification'
    });
};